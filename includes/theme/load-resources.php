...
function mytheme_load_resources() {
    ...
    wp_localize_script('mytheme','backendData', $backend_data );
}
 ...
 */
add_action( 'after_setup_theme', 'mytheme_add_styles_to_tinymce' );
function mytheme_add_styles_to_tinymce() {
 ...
 */
add_action( 'enqueue_block_editor_assets', 'mytheme_editor_resources' );
function mytheme_editor_resources() {
	wp_enqueue_script(
		handle: 'mytheme',
 ...
 */
add_action( 'admin_enqueue_scripts', 'mytheme_enqueue_custom_admin_resources' );
function mytheme_enqueue_custom_admin_resources() {
	wp_enqueue_style(
		handle: 'mytheme-admin',
